...
(function ($) {
	...
	// main menu links
	api( 'storytime_menu_link_colour', function( value ) {
			value.bind( function( to ) {
	...
	// main submenu links
	api( 'storytime_submenu_link_colour', function( value ) {
			value.bind( function( to ) {
	...
	api( 'storytime_submenu_link_hover_colour', function( value ) {
			value.bind( function( to ) {
	...
	api( 'storytime_menu_hover_link_colour', function( value ) {
		value.bind( function( to ) {
	...
	api( 'storytime_submenu_bg', function( value ) {
		value.bind( function( to ) {
	...
	api( 'storytime_submenu_border', function( value ) {
		value.bind( function( to ) {
