...
// Text Area
 function storytime_sanitize_textarea($input){
	return wp_kses_post( $input );
}

// Strip Slashes
	function storytime_sanitize_strip_slashes($input) {
 ...
 */
function storytime_sanitize_checkbox( $checked ) {
 ...
 */
function storytime_sanitize_select( $input, $setting ) {
